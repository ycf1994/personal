(function(){
    ...
    H5lock.prototype.makeState = function() {
        if (this.pswObj.step == 2) {
            ...
            document.getElementById('title').innerHTML = '请绘制手势密码解锁';
    ...
    H5lock.prototype.initDom = function(){
        ...
        var str = '<h4 id="title" class="title">请绘制手势密码解锁</h4>'+
            '<a id="updatePassword" style="position: absolute;right: 5px;top: 5px;color:#fff;font-size: 10px;display:block;">重置手势</a>'+
            '<canvas id="canvas" width="320" height="320" style="background-color: none;display: inline-block;margin-top: 15px;"></canvas>';
